...
},
{
    id: 9,
    kanji: "本",
    fr_meaning: ["le livre", "le présent", "l'essentiel", "l'origine", "le principal", "la réalité", "la vérité", "compteur d'objets allongés"],
    en_meaning: ["the book", "the present", "the main", "the origin", "the true", "the real", "counter for long cylindrical things"],
    readings: [{
        kun_yomi: ["もと"],
        on_yomi: ["ホン"]
    }],
...
},
{
    id: 10,
    kanji: "本",
    fr_meaning: ["dans", "dedans", "à l'intérieur", "le milieu", "le centre", "la moyenne"],
